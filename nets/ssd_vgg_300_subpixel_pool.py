...
class SSDSubpixelPoolNet(object):
    ...
    default_params = SSDParams(
        ...
        # feat_shapes = [(38, 38), (20, 20), (10, 10), (6, 6), (6, 6), (2, 2)],
    ...
    def __init__(self, params=None):
        ...
        if isinstance(params, SSDParams):
            ...
            self.params = SSDSubpixelPoolNet.default_params
    ...
    def net(self, inputs,
        ...
        if 'subpixel' in kargs and kargs['subpixel']['desubpixel']:
            r = ssd_net_desubpixel(inputs,
            ...
            r = ssd_net_subpixel_pool(inputs,
                                      num_classes=self.params.num_classes,
                                      feat_layers=self.params.feat_layers,
                                      anchor_sizes=self.params.anchor_sizes,
                                      anchor_ratios=self.params.anchor_ratios,
    ...
    def losses(self, logits, localisations,
        ...
        """
        return ssd_losses_hard_neg_mining(logits, localisations,
                                          gclasses, glocalisations, gscores,
...
def ssd_net_subpixel_pool(inputs,
                          num_classes=SSDSubpixelPoolNet.default_params.num_classes,
                          feat_layers=SSDSubpixelPoolNet.default_params.feat_layers,
                          anchor_sizes=SSDSubpixelPoolNet.default_params.anchor_sizes,
                          anchor_ratios=SSDSubpixelPoolNet.default_params.anchor_ratios,
                          normalizations=SSDSubpixelPoolNet.default_params.normalizations,
                          is_training=True,
                          dropout_keep_prob=0.5,
                          prediction_fn=slim.softmax,
                          reuse=None,
    ...
    with tf.variable_scope(scope, 'ssd_300_vgg', [inputs], reuse=reuse):
        ...
        # net = slim.avg_pool2d(net, [2, 2], scope = 'conv1/pool')
        # net = slim.conv2d(net, 64, [3, 3], stride = 1, scope = 'conv1/conv1_2')
        ...
        with tf.variable_scope(end_point):
            net = net_block9
            net = slim.conv2d(net, 128, [1, 1], scope='conv1x1')
            # net_block10 = slim.conv2d(net, 256, [3, 3], scope='conv3x3', padding='SAME')
...
def ssd_net_desubpixel(inputs,
    ...
    with tf.variable_scope(scope, 'ssd_300_vgg', [inputs], reuse=reuse):
        # Desubpixel
        # net = desubpixel.PS(inputs, r = kargs['subpixel']['subpixel_r'])
        subpixel_r = kargs['subpixel']['subpixel_r']
        # Original VGG-16 blocks.
        net = slim.conv2d(inputs, 64, [3*subpixel_r, 3*subpixel_r], stride = subpixel_r,
                          scope = 'subpixel_conv1')
        net = slim.conv2d(net, 64, [3, 3], scope = 'conv1/conv1_2')
        # net = slim.repeat(net, 2, slim.conv2d, 64, [3, 3], scope='conv1')
        end_points['block1'] = net
        # net = slim.max_pool2d(net, [2, 2], scope='pool1')
        # Block 2.
        net = slim.conv2d(net, 128, [3*subpixel_r, 3*subpixel_r], stride = subpixel_r,
                          scope = 'subpixel_conv2')
        net = slim.conv2d(net, 128, [3, 3], scope = 'conv2/conv2_2')
        # net = slim.repeat(net, 2, slim.conv2d, 128, [3, 3], scope='conv2')
        end_points['block2'] = net
        # net = slim.max_pool2d(net, [2, 2], scope='pool2')
        # Block 3.
        net = slim.conv2d(net, 256, [3*subpixel_r, 3*subpixel_r], stride = subpixel_r,
                          scope = 'subpixel_conv3')
        ...
        # net = slim.max_pool2d(net, [2, 2], scope='pool3')
        # Block 4.
        net = slim.conv2d(net, 512, [3*subpixel_r, 3*subpixel_r], stride = subpixel_r,
                          scope = 'subpixel_conv4')
...
# =========================================================================== #
#  Sample hard neg samples below neg_match_threshold
# =========================================================================== #
def ssd_losses_hard_neg_mining(logits, localisations,
                               gclasses, glocalisations, gscores,
                               match_threshold=0.5,
                               negative_ratio=3.,
                               alpha=1.,
