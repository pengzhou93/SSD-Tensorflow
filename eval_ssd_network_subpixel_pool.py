...
tf.app.flags.DEFINE_string(
    'model_name', 'ssd_300_vgg_subpixel_pool', 'The name of the architecture to evaluate.'
    '[ssd_300_vgg, ssd_512_vgg, ssd_300_vgg_subpixel, ssd_300_vgg_subpixel_pool]')
tf.app.flags.DEFINE_string(
    'checkpoint_path', './model/subpixel_pool/20170605-093643/nocrop',
