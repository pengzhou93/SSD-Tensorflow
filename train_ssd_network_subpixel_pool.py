...
tf.app.flags.DEFINE_string(
    'train_dir', './model/subpixel/l5e5',
    # 'train_dir', './model/subpixel_pool/20170605-093643/nocrop',
...
tf.app.flags.DEFINE_string(
    ...
    ' or "polynomial"')
tf.app.flags.DEFINE_float('learning_rate', 0.0025, 'Initial learning rate.')
tf.app.flags.DEFINE_float(
...
tf.app.flags.DEFINE_string(
    'model_name', 'ssd_300_vgg_subpixel_pool', 'The name of the architecture to train.')
tf.app.flags.DEFINE_string(
...
tf.app.flags.DEFINE_string(
    'checkpoint_path',
    # './model/subpixel_pool/20170604-194202',
    './ssd_model/tf/ssd-300-vgg-voc0712-coco/VGG_VOC0712_SSD_300x300_ft_iter_120000.ckpt/VGG_VOC0712_SSD_300x300_ft_iter_120000.ckpt',
...
tf.app.flags.DEFINE_string(
    ...
    # 'trainable_scopes', 'ssd_300_vgg/block',
    # 'trainable_scopes', 'ssd_300_vgg/block,ssd_300_vgg/conv3,ssd_300_vgg/conv4,ssd_300_vgg/conv5,ssd_300_vgg/conv6,ssd_300_vgg/conv7',
